 ...
 * cards down the middle — the review page, the activity feed. Creatures
 * live in the gutters and drift slowly across them. Fish face left in the
 * drawing, so they travel left.
 */
